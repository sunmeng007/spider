...
public class CrawlZhiHuKfc {
	public static final Log			LOG		= LogFactory.getLog(CrawlZhiHuKfc.class);

	public static Configuration	conf	= null;

	public CrawlZhiHuKfc() {
	...
	public static void main(String args[]) throws Exception {
		...
		injector.inject(crawlDb, new Path(dir, "zhihukfc.seed"));
		try {
			while (true) {
