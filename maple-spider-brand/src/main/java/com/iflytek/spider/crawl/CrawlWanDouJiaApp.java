...
public class CrawlWanDouJiaApp {
	public static final Log			LOG		= LogFactory.getLog(CrawlWanDouJiaApp.class);

	public static Configuration	conf	= null;

	public CrawlWanDouJiaApp() {
	...
	public static void main(String args[]) throws Exception {
		...
		Path dir = new Path("wandoujiaappv2");
		...
		injector.inject(crawlDb, new Path(dir, "wandoujia.seed"));
		try {
			while (true) {
